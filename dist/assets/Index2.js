    ...
    e.jsxs("div", {
      ...
      children: [
        e.jsx("div", {
          ...
          style: {
            backgroundImage:
              "url('https://images.unsplash.com/photo-1508098682722-e99c643e7f76?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')",
    ...
    const c = [
        {
          ...
          excerpt:
            "Футбольный клуб Сибирь выиграл со счетом 2:0 в домашнем матче против Спартака.",
          date: "15.05.2024",
          image:
        ...
        },
        {
          ...
          excerpt:
            "Иван Петров назначен новым главным тренером ФК Сибирь. Он приступит к обязанностям со следующей недели.",
          date: "10.05.2024",
          image:
        ...
        },
        {
          ...
          excerpt:
            "Футбольный клуб Сибирь объявляет о наборе детей в возрасте от 5 до 12 лет в детскую футбольную школу.",
          date: "05.05.2024",
          image:
                              ...
                              children: [
                                ...
                                e.jsx("div", {
                                  ...
                                  children: e.jsxs("div", {
                                    ...
                                    children: [
                                      e.jsx(y, { size: 14, className: "mr-2" }),
                                      e.jsx("span", { children: s.date }),
                                    ],
                                  }),
                                }),
