import { c as j, r as l, j as e, a as p } from "./index.js";
import { N as b, M as N, F as v } from "./Footer.js";
import { C as g } from "./calendar.js";
import { C as f } from "./chevron-right.js";
/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */ const y = j("ChevronLeft", [
    ["path", { d: "m15 18-6-6 6-6", key: "1wnfg3" }],
  ]),
  M = () => {
    const [s, i] = l.useState("upcoming"),
      [a, r] = l.useState(new Date().getMonth()),
      [n, o] = l.useState(new Date().getFullYear()),
      m = [
        {
          id: "1",
        ...
        .filter(
          (t) =>
            ...
            (s === "completed" && t.status === "completed")
        )
        .filter((t) => (s === "upcoming" ? !0 : t.month === a)),
      c = () => {
        a === 0 ? (r(11), o(n - 1)) : r(a - 1);
      },
      d = () => {
        a === 11 ? (r(0), o(n + 1)) : r(a + 1);
      },
      x = [
        "Январь",
        "Февраль",
            ...
            e.jsxs("div", {
              ...
              children: [
                e.jsx("div", {
                  ...
                  style: {
                    backgroundImage:
                      "url('https://images.unsplash.com/photo-1518091043644-c1d4457512c6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2069&q=80')",
                  ...
                  children: e.jsxs("div", {
                    ...
                    children: [
                      ...
                      e.jsx("p", {
                        ...
                        children:
                          "Расписание прошедших и предстоящих матчей ФК Гудаута",
                      }),
                    ],
                  }),
                }),
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsxs("button", {
                                onClick: c,
                                className:
                                  "px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200 transition-colors flex items-center",
                                children: [
                                  e.jsx(y, { size: 16, className: "mr-1" }),
                                  "Предыдущий месяц",
                                ],
                              }),
                              e.jsxs("button", {
                                ...
                                children: [
                                  "Следующий месяц",
                                  e.jsx(f, { size: 16, className: "ml-1" }),
                                ],
                              }),
                            ],
                          }),
                        ...
                        return e.jsxs(
                          "div",
                          {
                            ...
                            children: [
                              e.jsxs("div", {
                                className:
                                  "p-4 border-b border-gray-100 bg-fc-green/5 flex justify-between items-center",
                                children: [
                                  e.jsx("div", {
                                    className: "flex items-center",
                                    children: e.jsx("span", {
                                      className:
                                        "px-3 py-1 bg-white rounded-full text-sm font-medium text-fc-green",
                                      children: t.tournament,
                                    }),
                                  }),
                                  e.jsxs("div", {
                                    className:
                                    ...
                                    children: [
                                      ...
                                      t.status === "completed"
                                        ? e.jsx("a", {
                                            ...
                                            children: "Турнирная таблица",
                                          })
                                        : e.jsx("div", {
                                            className:
                                              "px-3 py-1 bg-fc-yellow/10 text-fc-yellow rounded-full text-xs font-medium",
                                            children: "Предстоящий матч",
                                          }),
                                    ],
                                  }),
                                ],
